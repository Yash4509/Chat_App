...
fun channelItemDesign(channels: channels){
    ...
    Row(modifier = Modifier.fillMaxWidth().padding(horizontal = 12.dp, vertical = 8.dp),
        ...
        Image(painter = painterResource(id = channels.image), contentDescription = null,
        ...
        Column {
            Text(text = channels.name, fontSize = 18.sp
        ...
        Button(onClick ={ isFollowing = !isFollowing}, colors = ButtonDefaults.buttonColors(
            ...
            Text(text = if(isFollowing){"Following"}
                else{"Follow"}, color = if (isFollowing){Color.White}
                else{Color.Black}, fontWeight = FontWeight.Bold)
        }
        }
